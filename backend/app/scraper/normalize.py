...
MAKES: dict[str, dict] = {
    ...
    # Long tail — canonical names match the training dataset's Make strings exactly.
    "Mazda": {"aliases": ["مازدا", "mazda"], "models": {"CX-9": ["cx-9", "cx9"], "6": ["mazda 6", "مازدا 6"]}},
    "BMW": {"aliases": ["بي ام دبليو", "بمدبليو", "bmw"], "models": {}},
    "Mitsubishi": {"aliases": ["ميتسوبيشي", "متسوبيشي", "mitsubishi"], "models": {
        "Pajero": ["باجيرو", "pajero"], "Lancer": ["لانسر", "lancer"]}},
    "Dodge": {"aliases": ["دودج", "dodge"], "models": {"Charger": ["تشارجر", "charger"], "Durango": ["دورانجو", "durango"]}},
    "Land Rover": {"aliases": ["لاندروفر", "لاند روفر", "رنج روفر", "رنجروفر", "land rover", "range rover"],
        "models": {"Range Rover": ["رنج روفر", "رنجروفر", "range rover"]}},
    "Jeep": {"aliases": ["جيب", "jeep"], "models": {"Grand Cherokee": ["جراند شيروكي", "grand cherokee"], "Wrangler": ["رانجلر", "wrangler"]}},
    "Chrysler": {"aliases": ["كرايسلر", "chrysler"], "models": {"C300": ["c300", "سي 300"]}},
    "Genesis": {"aliases": ["جينيسيس", "genesis"], "models": {}},
    "Renault": {"aliases": ["رينو", "renault"], "models": {}},
    "Changan": {"aliases": ["شانجان", "تشانجان", "changan"], "models": {}},
    "Audi": {"aliases": ["اودي", "أودي", "audi"], "models": {}},
    "Cadillac": {"aliases": ["كاديلاك", "cadillac"], "models": {"Escalade": ["اسكاليد", "escalade"]}},
    "Porsche": {"aliases": ["بورش", "porsche"], "models": {}},
    "MG": {"aliases": ["ام جي", "mg"], "models": {}},
    "Volkswagen": {"aliases": ["فولكس", "فولكسفاجن", "volkswagen"], "models": {}},
    "INFINITI": {"aliases": ["انفينيتي", "إنفينيتي", "infiniti"], "models": {}},
    "Suzuki": {"aliases": ["سوزوكي", "suzuki"], "models": {}},
    "Lincoln": {"aliases": ["لينكون", "lincoln"], "models": {"Navigator": ["نافيجيتر", "navigator"]}},
    "HAVAL": {"aliases": ["هافال", "haval"], "models": {}},
    "Jaguar": {"aliases": ["جاكوار", "jaguar"], "models": {}},
    "Peugeot": {"aliases": ["بيجو", "peugeot"], "models": {}},
    "MINI": {"aliases": ["ميني", "mini"], "models": {}},
    "Isuzu": {"aliases": ["ايسوزو", "isuzu"], "models": {}},
    "Hummer": {"aliases": ["همر", "hummer"], "models": {}},
}
